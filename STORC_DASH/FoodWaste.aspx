...
<asp:Content ID="Content1" ContentPlaceHolderID="FoodHolder" Runat="Server">
    <style type="text/css">
        .auto-style1 {
            position: relative;
            float: left;
    ...
    <div id="foodWaste">
        ...
        <div> 
            ...
            <asp:textbox runat="server" id="Weight" type="double" Width="80px" />
        ...
        <div>
          ...
          <!--<input id="Submit2" type="submit" value="Submit" />-->
            <asp:Button ID="buttonSubmit" Text="Submit" ValidationGroup="food" runat="server" OnClick="buttonSubmit_Click"/>
        </div>
    </div> 
</asp:Content>

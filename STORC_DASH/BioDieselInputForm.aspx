<%@ Page Title="" Language="C#" MasterPageFile="~/InputDataTabs.master" AutoEventWireup="true" CodeFile="BioDieselInputForm.aspx.cs" Inherits="BioDieselInputForm" %>

<asp:Content ID="Content5" ContentPlaceHolderID="diodHolder" Runat="Server">
    <style type="text/css">
        .auto-style1 {
            position: relative;
            float: left;

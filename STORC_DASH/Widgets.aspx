<%@ Page Title="" Language="C#" MasterPageFile="~/LeafTabs.master" AutoEventWireup="true" CodeFile="Widgets.aspx.cs" Inherits="Widgets" %>


<asp:Content ID="Content2" ContentPlaceHolderID="WidgetHolder" Runat="Server">
    <!--Scripts and Styles need to run this-->
    ...
    <!-- Styles required to run the widgets-->
    <style type="text/css">
        .deleteWidgetDiv {
            float: right;
            height: 22px;

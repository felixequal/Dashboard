<%@ Page Title="" Language="C#" MasterPageFile="~/InputDataTabs.master" AutoEventWireup="true" CodeFile="VermicultureInputForm.aspx.cs" Inherits="VermicultureInputForm" %>

<asp:Content ID="Content2" ContentPlaceHolderID="VermiHolder" Runat="Server">
<style type="text/css">
    .auto-style1 {
        position: relative;
        float: left;

...
<asp:Content ID="Content3" ContentPlaceHolderID="FTankHolder" Runat="Server">
           <style type="text/css">
        .auto-style1 {
            position: relative;
            float: left;
    ...
    <div id="FishProduction">
        ...
        <div>
            ...
            <asp:textbox runat="server" id="ac" type="double" Width="50px" />
        ...
        <div>
            ...
            <asp:textbox runat="server" id="o2" type="double" Width="50px" />
            <!-- Validator to ensure a number is in the text box (required)-->
        ...
        <div>
            ...
            <asp:textbox runat="server" id="ec" type="double" Width="50px" />
            <!-- Validator to ensure a number is in the text box (required)-->
        ...
        <div>
            ...
            <asp:textbox runat="server" id="d_o" type="double" Width="50px" />
            <!-- Validator to ensure a number is in the text box (required)-->
        ...
        <div>
            ...
            <asp:textbox runat="server" id="ph" type="double" Width="50px" />
            <!-- Validator to ensure a number is in the text box (required)-->
        ...
        <div>
            ...
            <asp:textbox runat="server" id="nh34" type="double" Width="50px" />
            <!-- Validator to ensure a number is in the text box (required)-->
        ...
        <div>
            ...
            <asp:textbox runat="server" id="no2" type="double" Width="50px" />
            <!-- Validator to ensure a number is in the text box (required)-->
        ...
        <div>
            ...
            <asp:textbox runat="server" id="no3" type="double" Width="50px" />
            <!-- Validator to ensure a number is in the text box (required)-->
        ...
        <div>
            ...
            <asp:textbox runat="server" id="fe" type="double" Width="50px" />
            <!-- Validator to ensure a number is in the text box (required)-->
        ...
        <div>
            ...
            <asp:textbox runat="server" id="p" type="double" Width="50px" />
            <!-- Validator to ensure a number is in the text box (required)-->
        ...
        <div>
            ...
            <asp:textbox runat="server" id="k" type="double" Width="50px" />
            <!-- Validator to ensure a number is in the text box (required)-->
    ...
    <div>
            ...
            <asp:textbox runat="server" id="co" type="double" Width="50px" />
            <!-- Validator to ensure a number is in the text box (required)-->
        ...
        <div>
            ...
            <asp:textbox runat="server" id="mg" type="double" Width="50px" />
            <!-- Validator to ensure a number is in the text box (required)-->
